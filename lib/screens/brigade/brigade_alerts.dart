...
class BrigadeAlerts extends StatefulWidget {
  const BrigadeAlerts({super.key});

  @override
  _BrigadeAlertsState createState() => _BrigadeAlertsState();
}

class _BrigadeAlertsState extends State<BrigadeAlerts> {
